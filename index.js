...
`;exports.Button=e=>{var{text:r,primary:t,disabled:o,size:i,onClick:p}=e,n=l(e,["text","primary","disabled","size","onClick"]);return a.default.createElement(d,Object.assign({type:"button",onClick:p,primary:t,disabled:o,size:i},n),r)},exports.Input=e=>{var{id:r,disabled:t,label:o,error:d,message:c,success:b,placeholder:u,onChange:f}=e,x=l(e,["id","disabled","label","error","message","success","placeholder","onChange"]);return a.default.createElement(a.default.Fragment,null,a.default.createElement(p,null,a.default.createElement(s,{disabled:t,error:d},o)),a.default.createElement(i,Object.assign({id:r,type:"text",onChange:f,disabled:t,error:d,success:b,placeholder:u},x)),a.default.createElement(n,null,a.default.createElement(s,{error:d},c)))};
